...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		icon = QtGui.QIcon()
		icon.addPixmap(QtGui.QPixmap(":/res/mucomicload.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon1 = QtGui.QIcon()
		icon1.addPixmap(QtGui.QPixmap(":/res/tango/preferences-system.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.menuFileSettings.setIcon(icon1)
		self.menuFileSettings.setObjectName("menuFileSettings")
		self.menuFileQuit = QtGui.QAction(MainWindow)
		icon2 = QtGui.QIcon()
		icon2.addPixmap(QtGui.QPixmap(":/res/tango/system-log-out.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.menuFileQuit.setIcon(icon2)
		self.menuFileQuit.setObjectName("menuFileQuit")
		self.actionAdd_series = QtGui.QAction(MainWindow)
		icon3 = QtGui.QIcon()
		icon3.addPixmap(QtGui.QPixmap(":/res/tango/list-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionAdd_series.setIcon(icon3)
		self.actionAdd_series.setObjectName("actionAdd_series")
		self.actionUpdate = QtGui.QAction(MainWindow)
		icon4 = QtGui.QIcon()
		icon4.addPixmap(QtGui.QPixmap(":/res/tango/view-refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon5 = QtGui.QIcon()
		icon5.addPixmap(QtGui.QPixmap(":/res/tango/go-bottom.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionDownload_Issue.setIcon(icon5)
		self.actionDownload_Issue.setObjectName("actionDownload_Issue")
		self.actionOpen = QtGui.QAction(MainWindow)
		icon6 = QtGui.QIcon()
		icon6.addPixmap(QtGui.QPixmap(":/res/tango/edit-find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon7 = QtGui.QIcon()
		icon7.addPixmap(QtGui.QPixmap(":/res/tango/emblem-favorite.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionFav_series.setIcon(icon7)
		self.actionFav_series.setObjectName("actionFav_series")
		self.actionDownload_Series = QtGui.QAction(MainWindow)
		self.actionDownload_Series.setIcon(icon5)
		...
		icon8 = QtGui.QIcon()
		icon8.addPixmap(QtGui.QPixmap(":/res/tango/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionRemove_series.setIcon(icon8)
	...
	def retranslateUi(self, MainWindow):
		...
		self.actionDownload_Issue.setText(QtGui.QApplication.translate("MainWindow", "Download", None, QtGui.QApplication.UnicodeUTF8))
		self.actionDownload_Issue.setToolTip(QtGui.QApplication.translate("MainWindow", "Download", None, QtGui.QApplication.UnicodeUTF8))
		self.actionOpen.setText(QtGui.QApplication.translate("MainWindow", "Read", None, QtGui.QApplication.UnicodeUTF8))
		self.actionOpen.setToolTip(QtGui.QApplication.translate("MainWindow", "Read", None, QtGui.QApplication.UnicodeUTF8))
		...
		self.actionDownload_Series.setText(QtGui.QApplication.translate("MainWindow", "Download", None, QtGui.QApplication.UnicodeUTF8))
